...
#define SCB_SHCSR_MEMFAULTACT_MASK 0x00000001UL

#define SCB_SHCSR_BUSFAULTACT_POS 1
#define SCB_SHCSR_BUSFAULTACT_MASK 0x00000002UL

#define SCB_SHCSR_USGFAULTACT_POS 3
#define SCB_SHCSR_USGFAULTACT_MASK 0x00000008UL
